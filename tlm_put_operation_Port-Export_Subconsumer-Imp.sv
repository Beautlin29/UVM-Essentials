...
class subconsumer extends uvm_component;
  ...
  virtual task put(int datar); // put operation definition -- because implementation is here
    #10;
    data = datar;
    `uvm_info("SUBCONS", $sformatf("Data received by Subconsumer: %0d", data), UVM_NONE);
  endtask
